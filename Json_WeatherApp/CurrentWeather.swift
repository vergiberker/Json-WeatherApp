...
struct CurrentWeather : Codable {
    ...
    init(tempature : Double , precipProbability : Double, summary : String , humidity : Double, icon : String) {
...
extension CurrentWeather {
    var iconImage : UIImage {
        ...
        case "celar-night" : return #imageLiteral(resourceName: "clear-night")
